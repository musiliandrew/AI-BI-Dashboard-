  ...
  const HomePage = () => {
    return (
      <div className="bg-gray-50">
        {/* Navigation - Improved with sticky positioning */}
        <nav className="bg-white shadow-sm sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              ...
              <a href="#" className="bg-cyan-500 text-white px-6 py-2.5 rounded-lg hover:bg-cyan-600 font-semibold transition-colors">
                Start Free Trial
              </a>
            </div>
          </div>
